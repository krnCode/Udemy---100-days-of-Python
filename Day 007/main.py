...
# Flow chart is in the same folder as the code
# -------------------------------------
...
# #TODO-1: - Create a variable called 'lives' to keep track of 
# # the number of lives left. Set 'lives' to equal 6.
# lives = 6
...
while not end_of_game:
    ...
    #TODO-2: - Import the stages from hangman_art.py and make
    # this error go away.
    print(stages[lives])
# -------------------------------------    